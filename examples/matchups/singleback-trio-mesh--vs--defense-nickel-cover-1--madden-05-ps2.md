# Matchup: `singleback-trio-mesh` vs `defense-nickel-cover-1`

**Rating:** neutral  •  **Best read:** TE

**Rationale:** Play's best_vs_defense matches: ['cover-1 (man on receivers, free safety high — picks happen at mesh)', 'cover-1 robber (robber gets crossed up)'] | Defense's best_against matches play type/tags: ['Mesh / drag concepts (robber breaks them up)']
