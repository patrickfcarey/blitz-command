# Matchup: `goal-line-power` vs `defense-goal-line-6-2`

**Rating:** neutral  •  **Best read:** None

**Rationale:** Play's best_vs_defense matches: ['cover-1 (no extra coverage to worry about)', 'any defense with predictable LB flow', 'Goal-line stand with 8-man front (still beat by extra blocker)'] | Play's worst_vs_defense matches: ['Defenses with stunts that cross the down-blocks', 'Goal-line stand with 9-man front + safety blitz'] | Defense's best_against matches play type/tags: ['Goal-line power runs']
