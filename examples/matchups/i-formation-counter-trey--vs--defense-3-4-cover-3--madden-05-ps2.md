# Matchup: `i-formation-counter-trey` vs `defense-3-4-cover-3`

**Rating:** neutral  •  **Best read:** None

**Rationale:** Play's best_vs_defense matches: ['cover-3 with predictable LB flow', 'any defense overplaying Power', 'speed-flow defenses that over-pursue the counter step'] | Defense's best_against matches play type/tags: ['Inside zone / power runs (NT eats up A-gaps, OLBs set edges)', '12 personnel / heavy run looks (4 LBs in the box concept)']
